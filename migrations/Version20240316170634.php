 ...
 */
final class Version20240316170634 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produits_informations_horraire_arv (produits_id INTEGER NOT NULL, informations_horraire_arv_id INTEGER NOT NULL, PRIMARY KEY(produits_id, informations_horraire_arv_id), CONSTRAINT FK_93490956CD11A2CF FOREIGN KEY (produits_id) REFERENCES produits (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_934909562AEEE24F FOREIGN KEY (informations_horraire_arv_id) REFERENCES informations_horraire_arv (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
